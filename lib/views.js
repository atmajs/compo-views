    ...
    */
	...
	(function () {
		ViewChanger = mask["class"].create({
			...
			show: (function (_show) {
				var _showWrapper = function show(_x, _x2, _x3) {
				...
				return _showWrapper;
			})(function (route, prevRoute, isInitial) {
				var _this = this;
			...
			show_: function show_(ani, route, isInitial) {
				...
				return mask["class"].Deferred.run(function (resolve) {
					_this.vm.showCompo_(route.value.compo, isInitial).then(function () {
	...
	var ViewManagerCompo = mask.Compo({
		...
		showCompo_: function showCompo_(compo, isInitial) {
			...
			return compo.show_().then(function () {
				return compo.emitIn("viewActivation", _this);
			});
		},
		...
		renderView: function renderView(route, model) {
			...
			return mask["class"].Deferred.run(function (resolve, reject, dfr) {
				...
				mask.renderAsync(route.value.getNodes(), model || _this.model, ctx, null, _this).done(function (frag, compo) {
